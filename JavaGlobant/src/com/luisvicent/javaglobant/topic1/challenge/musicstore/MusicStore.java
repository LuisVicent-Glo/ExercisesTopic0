...
public class MusicStore {
    public static void main(String[] args) {
        ...
        Reproductive reproductor = new BuildReproductor();
        ...
        do {
            ...
            if (optionColour == 1){
                reproductor.chooseColor(new FirstOptionColor()).chooseColor();
            }else if (optionColour == 2){
                reproductor.chooseColor(new SecondOptionColor()).chooseColor();
            }else {
                exit = false;
            ...
            if (optionBattery == 1){
                reproductor.chooseBattery(new FirstOptionBattery()).chooseBattery();
            }else if (optionBattery == 2){
                reproductor.chooseBattery(new SecondOptionBattery()).chooseBattery();
            }else {
                exit = false;
                System.out.println("Option Invalid");
                continue;
            ...
            if (optionCapacity == 1){
                reproductor.chooseCapacity(new FirstOptionCapacity()).chooseCapacity();
            }else if (optionCapacity == 2){
                reproductor.chooseCapacity(new SecondOptionCapacity()).chooseCapacity();
            }else {
                exit = false;
                System.out.println("Option Invalid");
                continue;
